    ...
    <div className="min-h-screen grid place-items-center bg-[#0f172a]">
      <div className="text-center">
        ...
        <a
          ...
          className="inline-flex items-center gap-3 rounded-lg border border-slate-600 bg-white px-6 py-2.5 text-sm font-medium text-slate-700 shadow-sm hover:bg-slate-50 transition-colors"
        >
